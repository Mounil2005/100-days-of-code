...
#     st.session_state.user = [deal_card(), deal_card()]
#     st.session_state.computer = [deal_card(), deal_card()]
#     st.session_state.game_over = False
#     st.session_state.message = ""

# # --- Display Cards ---
# if st.session_state.user:
#     user_total = ace_adjust(st.session_state.user)
#     computer_total = ace_adjust(st.session_state.computer)

#     st.subheader("Your Cards")
#     st.write(st.session_state.user, f"Total = {user_total}")

#     st.subheader("Computer's Cards")
#     if not st.session_state.game_over:
#         st.write([st.session_state.computer[0], "❓"])
#     else:
#         st.write(st.session_state.computer, f"Total = {computer_total}")

#     # --- Instant Win/Loss ---
#     user_blackjack = (11 in st.session_state.user and 10 in st.session_state.user)
#     computer_blackjack = (11 in st.session_state.computer and 10 in st.session_state.computer)

#     if user_blackjack and computer_blackjack:
#         st.session_state.message = "Computer Wins"
#         st.session_state.game_over = True
#     elif user_blackjack:
#         st.session_state.message = "User Wins"
#         st.session_state.game_over = True
...
#     if not st.session_state.game_over:
#         if st.button("Hit"):
#             st.session_state.user.append(deal_card())
#             user_total = ace_adjust(st.session_state.user)
#             if user_total > 21:
#                 st.session_state.message = "User Busts! Computer Wins"
#                 st.session_state.game_over = True
...
#                 st.session_state.computer.append(deal_card())
#                 computer_total = ace_adjust(st.session_state.computer)

#             # Decide Winner
#             if computer_total > 21:
#                 st.session_state.message = "Computer Busts! You Win!"
